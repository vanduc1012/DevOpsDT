...
function Register() {
  ...
  const validateConfirmPassword = (password, confirmPassword) => {
    if (!confirmPassword) return { valid: false, message: 'Vui lòng nhập lại mật khẩu' };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Sau khi đăng ký, chuyển đến trang đăng nhập
              ...
              <div className="form-group">
                ...
                <div className="password-input-wrapper">
                  <input
                    ...
                    required
                    className={touched.confirmPassword && !confirmPasswordValidation.valid ? 'input-error' : ''}
                  />
                  <button
                    type="button"
                    className="password-toggle"
                ...
                {touched.confirmPassword && !confirmPasswordValidation.valid && (
                  <span className="field-error">{confirmPasswordValidation.message}</span>
                )}
              </div>
            </div>
